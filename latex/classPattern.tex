...
{\em class\+\_\+value} & class whose the pattern belongs to. \\
\hline
...
\begin{DoxyParams}{Parameters}
{\em begin} & begining of feature vector \\
\hline
{\em end} & ending of feature vector \\
\hline
{\em index} & index of pattern. \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em dimension} & number of feature the vector dimension. \\
\hline
\end{DoxyParams}
...
Overloads the operator \mbox{[}\mbox{]}. 
