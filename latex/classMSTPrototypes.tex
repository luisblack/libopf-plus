...
Prim's algorithm is performed to generate the M\+S\+T. Two patterns on M\+S\+T are selected as prototypes if they are connected and belong to different classes. \begin{DoxyAuthor}{Authors}
